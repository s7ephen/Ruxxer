...
#html_document_body = RepeaterStringPDT("BlahBLah", 200)
html_document_body = FileReaderPDT("index.html")
...
twohun_ok = Dataflow("")
#twohun_ok.add_stage(StringPDT("200 OK\nContent-Length: "))
#twohun_ok.add_stage(StringPDT(str(len(html_document))))
#twohun_ok.add_stage(StringPDT(" 0"))
