...
firstDataflow.add_stage(StringPDT("Content-Length: 9"))
...
body=Dataflow(""); body.add_stage(RepeaterStringPDT("0123456789", 4000))

#firstDataflow.add_stage(StringPDT(str(len(body))))
firstDataflow.add_stage(StringPDT("9\n"))
firstDataflow.add_stage(body)
